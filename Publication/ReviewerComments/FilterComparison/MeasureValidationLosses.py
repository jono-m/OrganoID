...
from Core.Model import LoadModel, LoadLiteModel, Detect, PrepareImagesForModel, PrepareSegmentationsForModel
from Core.ImageHandling import LoadPILImages

model4 = LoadModel(Path(r"Publication\ReviewerComments\FilterComparison\Filter4_BEST"))
model8 = LoadLiteModel(Path(r"OptimizedModel"))
model16 = LoadModel(Path(r"Publication\ReviewerComments\FilterComparison\Filter16_BEST"))
